...
import com.game.app.databinding.FragmentCategoryChangeBinding
...
class CategoryChangeFragment : BaseFragment<CourseViewModel, FragmentCategoryChangeBinding, UserRepository>(){

    private lateinit var categoryHighAdapter: CategoryHighAdapterV
    private lateinit var coursePreferences: CourseChangePreferences

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        // Инициализация внутреннего хранилища
        coursePreferences = CourseChangePreferences(requireContext())

        categoryHighAdapter = CategoryHighAdapterV(requireContext(), categories = arrayListOf())

        // Добавление Item Decoration к RecyclerView
        // binding.recyclerViewChange.addItemDecoration(ItemDecoration(800, 800))
        binding.recyclerViewChange.setAdapter(
            requireContext(),
            categoryHighAdapter,
        ...
        viewModel.getCoursesByTitle(CategoryTitleConstants.CATEGORY_CHANGE_TITLE)
    ...
    override fun getFragmentBinding(
        ...
        container: ViewGroup?
    ) = FragmentCategoryChangeBinding.inflate(inflater, container, false)
