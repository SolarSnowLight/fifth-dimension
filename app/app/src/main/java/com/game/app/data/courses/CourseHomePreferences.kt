...
class CourseHomePreferences(
    ...
    companion object {
        private val KEY_COURSE = preferencesKey<String>(DataKeyConstants.KEY_COURSE_HOME)
        private val KEY_COURSE_IMG = preferencesKey<String>(DataKeyConstants.KEY_COURSE_HOME_IMG)
    }
}