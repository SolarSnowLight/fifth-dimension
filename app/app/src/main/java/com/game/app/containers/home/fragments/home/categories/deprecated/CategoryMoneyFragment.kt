...
import com.game.app.databinding.FragmentCategoryMoneyBinding
...
class CategoryMoneyFragment : BaseFragment<CourseViewModel, FragmentCategoryMoneyBinding, UserRepository>(){
    private lateinit var categoryHighAdapter: CategoryHighAdapterV
    private lateinit var coursePreferences: CourseMoneyPreferences

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        // Инициализация внутреннего хранилища
        coursePreferences = CourseMoneyPreferences(requireContext())

        categoryHighAdapter = CategoryHighAdapterV(requireContext(), categories = arrayListOf())

        // Добавление Item Decoration к RecyclerView
        // binding.recyclerViewMoney.addItemDecoration(ItemDecoration(800, 800))
        binding.recyclerViewMoney.setAdapter(
            requireContext(),
            categoryHighAdapter,
    ...
    override fun getFragmentBinding(
        ...
        container: ViewGroup?
    ) = FragmentCategoryMoneyBinding.inflate(inflater, container, false)
