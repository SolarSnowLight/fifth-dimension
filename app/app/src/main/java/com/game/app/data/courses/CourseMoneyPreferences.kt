...
class CourseMoneyPreferences(
    ...
    companion object {
        private val KEY_COURSE = preferencesKey<String>(DataKeyConstants.KEY_COURSE_MONEY)
        private val KEY_COURSE_IMG = preferencesKey<String>(DataKeyConstants.KEY_COURSE_MONEY_IMG)
    }
}