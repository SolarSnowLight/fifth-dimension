...
import com.game.app.data.courses.CourseChangePreferences
import com.game.app.data.courses.CourseHomePreferences
import com.game.app.databinding.FragmentCategoryChangeVBinding
...
class CategoryChangeVFragment : BaseFragment<HomeViewModel, FragmentCategoryChangeVBinding, UserRepository>(){
    private lateinit var noteCoursePreferences: NoteCoursePreferences
    private lateinit var courseChangePreferences: CourseChangePreferences
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        courseChangePreferences = CourseChangePreferences(requireContext())
        ...
        binding.recyclerViewChangeV.setAdapter(
            requireContext(),
            courseAdapterV,
        ...
        noteCoursePreferences.courses.asLiveData().observe(viewLifecycleOwner){
            if(it != null){
                ...
                val coursesChange = runBlocking {
                    courseChangePreferences.courses.first()
                }
                ...
                val coursesChangeData = Gson().fromJson(
                    coursesChange,
                ...
                if((coursesChangeData != null)
                    && (coursesChangeData.courses != null)
                    && (coursesChangeData.courses.isNotEmpty())){
                    courses.addAll(coursesChangeData.courses)
                }
                ...
                if(courses.isNotEmpty()){
                    ...
                    val categoryId = categories.categories[
                            categories.categories.indexOfFirst { it ->
                                it.title == CategoryTitleConstants.CATEGORY_CHANGE_TITLE
                            }
                    ].id
    ...
    override fun getFragmentBinding(
        ...
        container: ViewGroup?
    ) = FragmentCategoryChangeVBinding.inflate(inflater, container, false)
