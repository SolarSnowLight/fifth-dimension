...
class CourseDialogPreferences(
    ...
    companion object {
        private val KEY_COURSE = preferencesKey<String>(DataKeyConstants.KEY_COURSE_DIALOG)
        private val KEY_COURSE_IMG = preferencesKey<String>(DataKeyConstants.KEY_COURSE_DIALOG_IMG)
    }
}