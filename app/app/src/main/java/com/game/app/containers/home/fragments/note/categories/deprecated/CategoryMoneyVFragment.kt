...
import com.game.app.data.courses.CourseMoneyPreferences
import com.game.app.databinding.FragmentCategoryMoneyVBinding
...
class CategoryMoneyVFragment : BaseFragment<HomeViewModel, FragmentCategoryMoneyVBinding, UserRepository>(){
    private lateinit var noteCoursePreferences: NoteCoursePreferences
    private lateinit var courseMoneyPreferences: CourseMoneyPreferences
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        courseMoneyPreferences = CourseMoneyPreferences(requireContext())
        ...
        binding.recyclerViewMoneyV.setAdapter(
            requireContext(),
            courseAdapterV,
        ...
        noteCoursePreferences.courses.asLiveData().observe(viewLifecycleOwner){
            if(it != null){
                ...
                val coursesMoney = runBlocking {
                    courseMoneyPreferences.courses.first()
                }
                ...
                val coursesMoneyData = Gson().fromJson(
                    coursesMoney,
                ...
                if((coursesMoneyData != null)
                    && (coursesMoneyData.courses != null)
                    && (coursesMoneyData.courses.isNotEmpty())){
                    courses.addAll(coursesMoneyData.courses)
                }
                ...
                if(courses.isNotEmpty()){
                    ...
                    val categoryId = categories.categories[
                            categories.categories.indexOfFirst { it ->
                                it.title == CategoryTitleConstants.CATEGORY_MONEY_TITLE
                            }
                    ].id
    ...
    override fun getFragmentBinding(
        ...
        container: ViewGroup?
    ) = FragmentCategoryMoneyVBinding.inflate(inflater, container, false)
