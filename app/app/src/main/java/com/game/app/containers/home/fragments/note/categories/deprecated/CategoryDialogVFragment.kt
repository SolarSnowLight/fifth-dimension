...
import com.game.app.databinding.FragmentCategoryDialogVBinding
...
class CategoryDialogVFragment : BaseFragment<HomeViewModel, FragmentCategoryDialogVBinding, UserRepository>(){
    private lateinit var noteCoursePreferences: NoteCoursePreferences
    private lateinit var courseDialogPreferences: CourseDialogPreferences
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        courseDialogPreferences = CourseDialogPreferences(requireContext())
        ...
        binding.recyclerViewDialogV.setAdapter(
            requireContext(),
            courseAdapterV,
        ...
        noteCoursePreferences.courses.asLiveData().observe(viewLifecycleOwner){
            if(it != null){
                ...
                val coursesDialog = runBlocking {
                    courseDialogPreferences.courses.first()
                }
                ...
                val coursesDialogData = Gson().fromJson(
                    coursesDialog,
                ...
                if((coursesDialogData != null)
                    && (coursesDialogData.courses != null)
                    && (coursesDialogData.courses.isNotEmpty())){
                    courses.addAll(coursesDialogData.courses)
                }
                ...
                if(courses.isNotEmpty()){
                    ...
                    val categoryId = categories.categories[
                            categories.categories.indexOfFirst { it ->
                                it.title == CategoryTitleConstants.CATEGORY_DIALOG_TITLE
                            }
                    ].id
    ...
    override fun getFragmentBinding(
        ...
        container: ViewGroup?
    ) = FragmentCategoryDialogVBinding.inflate(inflater, container, false)
