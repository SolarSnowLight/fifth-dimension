...
import com.game.app.databinding.FragmentCategoryResourceVBinding
...
class CategoryResourceVFragment : BaseFragment<HomeViewModel, FragmentCategoryResourceVBinding, UserRepository>(){
    private lateinit var noteCoursePreferences: NoteCoursePreferences
    private lateinit var courseResourcePreferences: CourseResourcePreferences
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        courseResourcePreferences = CourseResourcePreferences(requireContext())
        ...
        binding.recyclerViewResourceV.setAdapter(
            requireContext(),
            courseAdapterV,
        ...
        noteCoursePreferences.courses.asLiveData().observe(viewLifecycleOwner){
            if(it != null){
                ...
                val coursesResources = runBlocking {
                    courseResourcePreferences.courses.first()
                }
                ...
                val coursesResourcesData = Gson().fromJson(
                    coursesResources,
                ...
                if((coursesResourcesData != null)
                    && (coursesResourcesData.courses != null)
                    && (coursesResourcesData.courses.isNotEmpty())){
                    courses.addAll(coursesResourcesData.courses)
                }
                ...
                if(courses.isNotEmpty()){
                    ...
                    val categoryId = categories.categories[
                            categories.categories.indexOfFirst { it ->
                                it.title == CategoryTitleConstants.CATEGORY_RESOURCE_TITLE
                            }
                    ].id
    ...
    override fun getFragmentBinding(
        ...
        container: ViewGroup?
    ) = FragmentCategoryResourceVBinding.inflate(inflater, container, false)
